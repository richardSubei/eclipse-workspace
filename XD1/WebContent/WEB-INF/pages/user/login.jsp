			...
			<div style="width:1200px;margin:0 auto;position: relative;z-index: 999;">
				<div class="loginDiv " style="display: block;"  id="login" >
					...
					<c:out value="${msg }"></c:out>
				 	...
				 	<span class="left1"></span>	<input type="text" name="userPhone" class="am-form-field"  placeholder="手机号/用户名" style="padding-left: 50px;margin-top: 48px;font-size: 12px;"/>
				 </div>	
				 
				 <div class="am-u-sm-12" style="margin-top: 21px;padding-left: 30px;padding-right: 30px;">
				  <span class="left2"></span>	  <input type="password" name="userPassword" class="am-form-field"  placeholder="请输入密码"style="padding-left: 50px;font-size: 12px;"/>
				 </div>	
				...
				<input type="submit" class="am-btn am-btn-warning" style="width: 100%;border-radius: 5px;font-size: 16px;" value="登录"/>	
				</div>
				<div class="am-u-sm-12" style="padding-left: 30px;padding-right: 30px;">
