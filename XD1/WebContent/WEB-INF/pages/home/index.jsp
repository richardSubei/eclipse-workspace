...
<html>
	<head>
		...
		<title>许多零食</title>
		<link href="${ctx }/css/itcast/slider.css" rel="stylesheet" type="text/css"/>
		<link href="${ctx }/css/itcast/common.css" rel="stylesheet" type="text/css"/>
		<link href="${ctx }/css/itcast/index.css" rel="stylesheet" type="text/css"/>
	...
	<div class="span5">
		<div class="logo">
			<a href="./网上商城/index.htm">
				<img src="${ctx }/img/itcast/logo.gif" alt="传智播客"/>
			</a>
		</div>
	</div>
	<div class="span9">
		<div class="headerAd">
			<img src="${ctx }/img/itcast/header.jpg" width="320" height="50" alt="正品保障" title="正品保障"/>
		</div>	
	</div>
			...
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
						...
						<ul class="tabContent" style="display: block;">
							<s:iterator var="p" value="hList">
								<li>
									<a target="_blank" href="" data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;"></a>
								</li>
							</s:iterator>
							...
							<s:iterator var = "p" value="nList">
								<li>
									<a target="_blank" href="">
											<img src="" data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;">
										</a>									
								</li>
							</s:iterator>
...
<div class="container footer">
	<div class="span24">
		<div class="footerAd">
					<img src="${ctx }/img/itcast/footer.jpg" width="950" height="52" alt="我们的优势" title="我们的优势">
</div>	</div>
	<div class="span24">
		<ul class="bottomNav">
					<li>
